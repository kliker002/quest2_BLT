...
function vertical_check(ask_input, index_letter) { //проверка позиций вертикальных блоков
    var result_num = 0;
...
function horizontal_check(ask_input, index_letter) {//проверка позиций горизонтальных блоков
